...
cd ${SRC}
LOG=libgnomecanvas-gnome-platform.log
...
unpack_tarball libgnomecanvas-${LIBGNOMECANVAS_VER}
cd ${PKGDIR}

max_log_init libgnomecanvas ${LIBGNOMECANVAS_VER} "gnome-platform (shared)" ${CONFLOGS} ${LOG}
